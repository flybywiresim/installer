...
export function callWarningModal(show: boolean, track: ModTrack | null, setTrack?: boolean, findAndSetTrack?: CallableFunction): ShowWarningModalAction {
    let trackHandle: null | CallableFunction = null;

    if (typeof findAndSetTrack !== 'undefined') {
