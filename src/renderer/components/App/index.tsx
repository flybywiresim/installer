                    ...
                    tracks: [
                        {
                            name: 'Stable',
                            key: 'a32nx-stable',
                            url: 'https://flybywire.b-cdn.net/stable/A32NX-stable.zip',
                        ...
                        },
                        {
                            name: 'Development',
                            key: 'a32nx-dev',
                            url: 'https://flybywire.b-cdn.net/vmaster/A32NX-master.zip',
                            isExperimental: false,
                            get latestVersionName() {
                        ...
                        },
                        {
                            name: 'Custom FBW',
                            key: 'a32nx-fbw',
                            url: 'https://flybywire.b-cdn.net/vmaster-cfbw/A32NX-master-cfbw.zip',
                            isExperimental: true,
                            get latestVersionName() {
