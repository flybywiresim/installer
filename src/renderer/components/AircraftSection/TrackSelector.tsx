    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col px-5 py-2">
                ...
                <span className="text-lg text-teal-50 -mt-0.5"><code>{latestVersionName} {dateFormat(latestVersionDate, settings.get('mainSettings.dateLayout') as string)}</code></span>
            </div>
        </div>
    );
};
