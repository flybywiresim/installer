...
const ConversionProgress: React.FC = () => {
    ...
    return (
        <div className="flex flex-row gap-x-2 items-center">
            ...
            <span className=" w-16 text-xl text-white text-right">{(completedConversions || conversionsToPerform) ? completedConversions / (conversionsToPerform + completedConversions) * 100 + '%' : '0%'}</span>
        </div>
    );
};
