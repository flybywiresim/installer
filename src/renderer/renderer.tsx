...
InstallerConfiguration.obtain().then((config: Configuration) => {
    ...
    ReactDOM.render(
        <div className="h-screen flex flex-col gap-y-5 justify-center items-center bg-navy text-gray-100">
            ...
            <button className="bg-navy-lightest hover:bg-navy-lighter px-5 py-2 text-lg font-semibold rounded-lg outline-none" onClick={() => remote.app.quit()}>Close the Installer</button>
        </div>,
        document.getElementById('root')
    );
});
